...
class centred_psf_highSN(SimuIma):
    def __init__(self, size=(50, 50)):
        ...
        self.practiceima(npsf=1, edge=0.45, psffluxrange=[500000, 5000000], bgrange=[100,500], sigmarange=[3,6], ronrange=[1, 5])
...
class centred_psf_lowSN(SimuIma):
    def __init__(self, size=(50, 50)):
        ...
        """
        SimuIma.__init__(self, size=size)
        self.practiceima(npsf=1, edge=0.45, psffluxrange=[5000, 20000], bgrange=[100,500], sigmarange=[3,6], ronrange=[1, 5])
...
class crowded_field(SimuIma):
    def __init__(self, size=(100, 100)):
        ...
        self.practiceima(npsf=self.npsf, edge=0.05, psffluxrange=[40000, 100000], bgrange=[100, 500], sigmarange=[3, 6], ronrange=[1, 5])
...
class tutorial_image(SimuIma):
    ...
    def __init__(self):
        ...
        self.addPSF(20, 20, 2, 50000)
        self.addPSF(30, 30, 2, 4000)
        self.add_bg(100)
        self.add_shot(1)
        self.lock()
